...
epochs_map = {
    ...
    ("tinyimagenet", "resnet18", "mtl_ibp", 1 / 255): 160,
    ("tinyimagenet", "resnet18", "sabr", 1 / 255): 160,
    ("tinyimagenet", "resnet18", "shi", 1 / 255): 160,
    ("tinyimagenet", "resnet18", "crown_ibp", 1 / 255): 160,
    ("tinyimagenet", "cnn7", "mtl_ibp", 1 / 255): 160,
    ("tinyimagenet", "cnn7", "sabr", 1 / 255): 160,
    ("tinyimagenet", "cnn7", "shi", 1 / 255): 160,
    ("tinyimagenet", "cnn7", "crown_ibp", 1 / 255): 160,
    ("tinyimagenet", "wide_cnn7", "mtl_ibp", 1 / 255): 160,
    ("tinyimagenet", "wide_cnn7", "sabr", 1 / 255): 160,
    ("tinyimagenet", "wide_cnn7", "shi", 1 / 255): 160,
    ("tinyimagenet", "wide_cnn7", "crown_ibp", 1 / 255): 160,
}
...
("tinyimagenet", "resnet18", "mtl_ibp", 1 / 255): (0.15, 0.2),
    ("tinyimagenet", "resnet18", "sabr", 1 / 255): (0.15, 0.2),
    ("tinyimagenet", "resnet18", "shi", 1 / 255): (0.15, 0.2),
    ("tinyimagenet", "resnet18", "crown_ibp", 1 / 255): (0.15, 0.2),
    ("tinyimagenet", "cnn7", "mtl_ibp", 1 / 255): (0.15, 0.2),
    ("tinyimagenet", "cnn7", "sabr", 1 / 255): (0.15, 0.2),
    ("tinyimagenet", "cnn7", "shi", 1 / 255): (0.15, 0.2),
    ("tinyimagenet", "cnn7", "crown_ibp", 1 / 255): (0.15, 0.2),
    ("tinyimagenet", "wide_cnn7", "mtl_ibp", 1 / 255): (0.15, 0.2),
    ("tinyimagenet", "wide_cnn7", "sabr", 1 / 255): (0.15, 0.2),
    ("tinyimagenet", "wide_cnn7", "shi", 1 / 255): (0.15, 0.2),
    ("tinyimagenet", "wide_cnn7", "crown_ibp", 1 / 255): (0.15, 0.2),
...
def run(method, dataset, epochs, network, eps, seed, min_cert_acc, min_nat_acc, complete_verify=False):
    ...
    batch_size = 512
    if dataset == "tinyimagenet" and method in ["crown_ibp", "crown_ibp_nofusion"]:
        batch_size = 256
    ...
    if dataset == "cifar10":
        ...
        train_loader, val_loader, test_loader = load_tinyimagenet(
            batch_size=batch_size,
            val_split=True,
            data_root=DATA_ROOT,
        )
    ...
    wrapped_model.hpo(
        ...
        defaults={},
        output_dir=f"{RESULTS_ROOT}/hpo/validation/optuna_studies/{dataset}_{network}_{method}_{eps}_{seed}_complete_{complete_verify}",
        budget_time=np.inf,
        budget_trials=100,
        seed=seed,
